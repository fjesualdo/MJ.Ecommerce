...
namespace MJ.Solutions.Carrinho.API.Migrations
{
    ...
    [Migration("20220509233212_CarrinhoCascade")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MJ.Solutions.Carrinho.API.Model.CarrinhoCliente", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MJ.Solutions.Carrinho.API.Model.CarrinhoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MJ.Solutions.Carrinho.API.Model.CarrinhoCliente", b =>
                {
                    b.OwnsOne("MJ.Solutions.Carrinho.API.Model.Voucher", "Voucher", b1 =>
                        {
            ...
            modelBuilder.Entity("MJ.Solutions.Carrinho.API.Model.CarrinhoItem", b =>
                {
                    b.HasOne("MJ.Solutions.Carrinho.API.Model.CarrinhoCliente", "CarrinhoCliente")
                        .WithMany("Itens")
