...
using MJ.Solutions.Core.SpecificationResult.Result;
using MJ.Solutions.Core.SpecificationResult.Validation;
using System;
using System.Linq.Expressions;

namespace MJ.Solutions.Core.SpecificationResult
{
